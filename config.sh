...
yaourt -Sy iso-flag-png macos-arc-white-theme mint-cinnamon-themes mint-sounds mint-x-icons mintlocale vimix-gtk-themes-git vimix-icon-theme networkmanager-l2tp networkmanager-openconnect networkmanager-pptp networkmanager-openvpn
fi
